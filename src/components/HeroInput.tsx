    ...
    >
      <div className="flex w-full items-center bg-[#f8f6f3] shadow-lg rounded-2xl px-6 py-4 relative gap-3 border border-input">
        ...
        <button
          type="button"
          tabIndex={-1}
          className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-neutral-200 shadow-sm text-gray-700 text-sm font-medium hover:bg-neutral-50 transition hover:shadow group"
        >
